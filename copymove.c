...
// 	int result;
// 	Directory *entry1;
// 	//entry1->permissions[0] = 1;
// 	//strcpy(entry1->permissions, "10000000000");
// 	result = copy(sourceFile, destinationFile, entry1);
// 	if (result == 1)
// 	{
...
*/
int copy(char *sourceFile, char *destination, Directory *entry)
{
